...
1. Read `docs/agent-feedback-workflow.md` and `docs/product-experience-spec.md` from the latest `main`.
...
8. Change only the canonical source file(s). Preserve the product rule: scenario first, key fact first, action first, evidence-oriented, concise.
